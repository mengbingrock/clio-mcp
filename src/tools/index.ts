...
export const TOOL_META: Readonly<Record<string, ToolMeta>> = {
  ...
  list_task_types: { title: "List task types", readOnly: true },
  get_task: { title: "Get task", readOnly: true },
  ...
  get_calendar_entry: { title: "Get calendar entry", readOnly: true },
  list_calendars: { title: "List calendars", readOnly: true },
  create_calendar_entry: { title: "Create calendar entry", readOnly: false },
  update_calendar_entry: { title: "Update calendar entry", readOnly: false, idempotent: true },
  delete_calendar_entry: { title: "Delete calendar entry", readOnly: false, destructive: true, idempotent: true },
  // activities
